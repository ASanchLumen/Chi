...
export function buildPortal({dest = 'dist' }) {
  return gulp.src(
    path.join(__dirname, '..', 'src', 'chi', 'themes', 'portal', 'index.scss')
  )
    .pipe(plumber())
    .pipe(sass({
      includePaths: [
...
export function buildColt({dest = 'dist' }) {
  return gulp.src(
    path.join(__dirname, '..', 'src', 'chi', 'themes', 'colt', 'index.scss')
  )
    .pipe(plumber())
    .pipe(sass({
      includePaths: [
